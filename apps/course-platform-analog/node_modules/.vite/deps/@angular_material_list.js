...
// node_modules/.pnpm/@angular+material@18.0.1_@angular+animations@18.0.1_@angular+core@18.0.1_rxjs@7.8.1_zone.js@0_uua6ktl5ocburfvrx6mhehqyf4/node_modules/@angular/material/fesm2022/list.mjs
var _c0 = ["*"];
...
var __MatListItemGraphicBase = class __MatListItemGraphicBase {
  ...
  _isAlignedAtStart() {
    var _a;
    return !this._listOption || ((_a = this._listOption) == null ? void 0 : _a._getTogglePosition()) === "after";
  }
};
...
var _MatListItemBase = class _MatListItemBase {
  ...
  get disableRipple() {
    var _a;
    return this.disabled || this._disableRipple || this._noopAnimations || !!((_a = this._listBase) == null ? void 0 : _a.disableRipple);
  }
  set disableRipple(value) {
    this._disableRipple = coerceBooleanProperty(value);
  }
  ...
  get disabled() {
    var _a;
    return this._disabled || !!((_a = this._listBase) == null ? void 0 : _a.disabled);
  }
  set disabled(value) {
    this._disabled = coerceBooleanProperty(value);
  }
...
var _MatListOption = class _MatListOption extends MatListItemBase {
  ...
  getLabel() {
    var _a, _b, _c;
    const titleElement = (_b = (_a = this._titles) == null ? void 0 : _a.get(0)) == null ? void 0 : _b._elementRef.nativeElement;
    const labelEl = titleElement || ((_c = this._unscopedContent) == null ? void 0 : _c.nativeElement);
    return (labelEl == null ? void 0 : labelEl.textContent) || "";
  }
...
var _MatSelectionList = class _MatSelectionList extends MatListBase {
  ...
  set disabled(value) {
    ...
    if (this._selectionListDisabled) {
      (_a = this._keyManager) == null ? void 0 : _a.setActiveItem(-1);
    }
  }
  /** Implemented as part of ControlValueAccessor. */
  registerOnChange(fn) {
