import {
  ...
  MatFormField,
  MatFormFieldControl
} from "./chunk-WXVCFJIJ.js";
import "./chunk-GP7HKVQZ.js";
import "./chunk-T7O5NUS3.js";
import {
  FormGroupDirective,
  NG_VALUE_ACCESSOR,
  NgControl,
...
// node_modules/.pnpm/@angular+material@18.0.1_@angular+animations@18.0.1_@angular+core@18.0.1_rxjs@7.8.1_zone.js@0_uua6ktl5ocburfvrx6mhehqyf4/node_modules/@angular/material/fesm2022/chips.mjs
...
var _MatChip = class _MatChip {
  ...
  get ripple() {
    var _a;
    return (_a = this._rippleLoader) == null ? void 0 : _a.getRipple(this._elementRef.nativeElement);
  }
  set ripple(v) {
    var _a;
    (_a = this._rippleLoader) == null ? void 0 : _a.attachRipple(this._elementRef.nativeElement, v);
  }
  constructor(_changeDetectorRef, _elementRef, _ngZone, _focusMonitor, _document, animationMode, _globalRippleOptions, tabIndex) {
    ...
    this._monitorFocus();
    (_a = this._rippleLoader) == null ? void 0 : _a.configureRipple(this._elementRef.nativeElement, {
  ...
  ngOnDestroy() {
    ...
    (_a = this._rippleLoader) == null ? void 0 : _a.destroyRipple(this._elementRef.nativeElement);
    (_b = this._actionChanges) == null ? void 0 : _b.unsubscribe();
    this.destroyed.emit({
      chip: this
    });
  ...
  _isRippleDisabled() {
    var _a;
    return this.disabled || this.disableRipple || this._animationsDisabled || this._isBasicChip || !!((_a = this._globalRippleOptions) == null ? void 0 : _a.disabled);
  }
...
var _MatChipOption = class _MatChipOption extends MatChip {
  constructor() {
    ...
    this._chipListHideSingleSelectionIndicator = ((_a = this._defaultOptions) == null ? void 0 : _a.hideSingleSelectionIndicator) ?? false;
...
var _MatChipSet = class _MatChipSet {
  ...
  _setUpFocusManagement() {
    ...
    (_a = this._dir) == null ? void 0 : _a.change.pipe(takeUntil(this._destroyed)).subscribe((direction) => this._keyManager.withHorizontalOrientation(direction));
  }
  /**
...
var _MatChipListbox = class _MatChipListbox extends MatChipSet {
  constructor() {
    ...
    this.required = false;
    this._hideSingleSelectionIndicator = ((_a = this._defaultOptions) == null ? void 0 : _a.hideSingleSelectionIndicator) ?? false;
...
var _MatChipGrid = class _MatChipGrid extends MatChipSet {
  ...
  get required() {
    var _a, _b;
    return this._required ?? ((_b = (_a = this.ngControl) == null ? void 0 : _a.control) == null ? void 0 : _b.hasValidator(Validators.required)) ?? false;
  }
  set required(value) {
  ...
  setDescribedByIds(ids) {
    ...
    (_a = this._chipInput) == null ? void 0 : _a.setDescribedByIds(ids);
  }
  /**
   * Implemented as part of ControlValueAccessor.
   * @docs-private
