...
} from "./chunk-UFCLU42B.js";
import {
  MatButton,
  MatButtonModule,
  MatIconButton
} from "./chunk-3K7REQWH.js";
import {
  MAT_FORM_FIELD,
  MatFormFieldControl
...
// node_modules/.pnpm/@angular+material@18.0.1_@angular+animations@18.0.1_@angular+core@18.0.1_rxjs@7.8.1_zone.js@0_uua6ktl5ocburfvrx6mhehqyf4/node_modules/@angular/material/fesm2022/datepicker.mjs
...
var _MatCalendarBody = class _MatCalendarBody {
  ...
  constructor(_elementRef, _ngZone) {
    ...
    this._touchmoveHandler = (event) => {
      ...
      this._ngZone.run(() => this.previewChange.emit({
        value: (cell == null ? void 0 : cell.enabled) ? cell : null,
        event
      }));
    };
    ...
    this._mouseupHandler = (event) => {
      ...
      this._ngZone.run(() => {
        ...
        this.dragEnded.emit({
          value: (cell == null ? void 0 : cell.rawValue) ?? null,
          event
        });
      });
    };
