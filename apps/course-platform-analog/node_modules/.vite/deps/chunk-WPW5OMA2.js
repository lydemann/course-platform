...
// node_modules/.pnpm/@angular+cdk@18.0.1_@angular+common@18.0.1_@angular+core@18.0.1_rxjs@7.8.1_zone.js@0.14.3__rx_rk6fatukoi4qp5fzalhod5vxee/node_modules/@angular/cdk/fesm2022/layout.mjs
...
// node_modules/.pnpm/@angular+cdk@18.0.1_@angular+common@18.0.1_@angular+core@18.0.1_rxjs@7.8.1_zone.js@0.14.3__rx_rk6fatukoi4qp5fzalhod5vxee/node_modules/@angular/cdk/fesm2022/a11y.mjs
var ID_DELIMITER = " ";
...
function getAriaReferenceIds(el, attr) {
  ...
  return (attrValue == null ? void 0 : attrValue.match(/\S+/g)) ?? [];
}
...
var ListKeyManager = class {
  ...
  destroy() {
    var _a, _b;
    this._typeaheadSubscription.unsubscribe();
    (_a = this._itemChangesSubscription) == null ? void 0 : _a.unsubscribe();
...
var _InteractivityChecker = class _InteractivityChecker {
  ...
  isFocusable(element, config) {
    return isPotentiallyFocusable(element) && !this.isDisabled(element) && ((config == null ? void 0 : config.ignoreVisibility) || this.isVisible(element));
  }
};
...
var _CdkTrapFocus = class _CdkTrapFocus {
  ...
  get enabled() {
    var _a;
    return ((_a = this.focusTrap) == null ? void 0 : _a.enabled) || false;
  }
  set enabled(value) {
    if (this.focusTrap) {
  ...
  ngOnDestroy() {
    var _a;
    (_a = this.focusTrap) == null ? void 0 : _a.destroy();
  ...
  ngAfterContentInit() {
    var _a;
    (_a = this.focusTrap) == null ? void 0 : _a.attachAnchors();
    if (this.autoCapture) {
      this._captureFocus();
    }
  }
  ...
  ngOnChanges(changes) {
    ...
    if (autoCaptureChange && !autoCaptureChange.firstChange && this.autoCapture && ((_a = this.focusTrap) == null ? void 0 : _a.hasAttached())) {
      this._captureFocus();
    }
  }
  _captureFocus() {
    ...
    (_a = this.focusTrap) == null ? void 0 : _a.focusInitialElementWhenReady();
  }
};
...
var _InputModalityDetector = class _InputModalityDetector {
  ...
  constructor(_platform, ngZone, document2, options) {
    ...
    this._onKeydown = (event) => {
      var _a, _b;
      if ((_b = (_a = this._options) == null ? void 0 : _a.ignoreKeys) == null ? void 0 : _b.some((keyCode) => keyCode === event.keyCode)) {
        return;
      }
  ...
  announce(message, ...args) {
    ...
    return this._ngZone.runOutsideAngular(() => {
      ...
      this._previousTimeout = setTimeout(() => {
        ...
        (_a = this._currentResolve) == null ? void 0 : _a.call(this);
...
var _FocusMonitor = class _FocusMonitor {
  constructor(_ngZone, _platform, _inputModalityDetector, document2, options) {
    ...
    this._detectionMode = (options == null ? void 0 : options.detectionMode) || FocusMonitorDetectionMode.IMMEDIATE;
  }
...
//# sourceMappingURL=chunk-WPW5OMA2.js.map
