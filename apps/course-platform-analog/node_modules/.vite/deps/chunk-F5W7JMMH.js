...
// node_modules/.pnpm/@angular+core@18.0.1_rxjs@7.8.1_zone.js@0.14.3/node_modules/@angular/core/fesm2022/primitives/signals.mjs
...
// node_modules/.pnpm/@angular+core@18.0.1_rxjs@7.8.1_zone.js@0.14.3/node_modules/@angular/core/fesm2022/primitives/event-dispatch.mjs
...
var ActionResolver = class {
  ...
  getParentNode(element) {
    ...
    if ((parentNode == null ? void 0 : parentNode.nodeName) === "#document-fragment") {
      return (parentNode == null ? void 0 : parentNode.host) ?? null;
    }
    return parentNode;
  }
  /**
...
// node_modules/.pnpm/@angular+core@18.0.1_rxjs@7.8.1_zone.js@0.14.3/node_modules/@angular/core/fesm2022/core.mjs
...
function requiresRefreshOrTraversal(lView) {
  var _a;
  return !!(lView[FLAGS] & (1024 | 8192) || ((_a = lView[REACTIVE_TEMPLATE_CONSUMER]) == null ? void 0 : _a.dirty));
}
function updateAncestorTraversalFlagsOnAttach(lView) {
  var _a;
  (_a = lView[ENVIRONMENT].changeDetectionScheduler) == null ? void 0 : _a.notify(7);
  if (lView[FLAGS] & 64) {
    lView[FLAGS] |= 1024;
  }
...
function markAncestorsForTraversal(lView) {
  var _a;
  (_a = lView[ENVIRONMENT].changeDetectionScheduler) == null ? void 0 : _a.notify(0);
...
var OutputEmitterRef = class {
  ...
  subscribe(callback) {
    ...
    return {
      unsubscribe: () => {
        var _a, _b;
        const idx = (_a = this.listeners) == null ? void 0 : _a.indexOf(callback);
        if (idx !== void 0 && idx !== -1) {
    ...
    try {
      for (const listenerFn of this.listeners) {
        try {
          ...
          (_a = this.errorHandler) == null ? void 0 : _a.handleError(err);
        }
      }
    } finally {
...
var _QueryList = class _QueryList {
  ...
  setDirty() {
    var _a;
    this.dirty = true;
    (_a = this._onDirty) == null ? void 0 : _a.call(this);
  }
  /** internal */
  destroy() {
...
var CSP_NONCE = new InjectionToken(ngDevMode ? "CSP nonce" : "", {
  ...
  factory: () => {
    var _a, _b;
    return ((_b = (_a = getDocument().body) == null ? void 0 : _a.querySelector("[ngCspNonce]")) == null ? void 0 : _b.getAttribute("ngCspNonce")) || null;
  }
});
...
function getTextNodeContent(node) {
  var _a;
  return (_a = node.textContent) == null ? void 0 : _a.replace(/\s/gm, "");
}
...
function isRNodeClaimedForHydration(node) {
  var _a;
  return ((_a = readHydrationInfo(node)) == null ? void 0 : _a.status) === HydrationStatus.Hydrated;
}
...
function getSegmentHead(hydrationInfo, index) {
  var _a;
  return ((_a = hydrationInfo.segmentHeads) == null ? void 0 : _a[index]) ?? null;
}
function getNgContainerSize(hydrationInfo, index) {
  var _a, _b;
  const data = hydrationInfo.data;
  let size = ((_a = data[ELEMENT_CONTAINERS]) == null ? void 0 : _a[index]) ?? null;
  if (size === null && ((_b = data[CONTAINERS]) == null ? void 0 : _b[index])) {
...
function isSerializedElementContainer(hydrationInfo, index) {
  var _a;
  return ((_a = hydrationInfo.data[ELEMENT_CONTAINERS]) == null ? void 0 : _a[index]) !== void 0;
}
function getSerializedContainerViews(hydrationInfo, index) {
  var _a;
  return ((_a = hydrationInfo.data[CONTAINERS]) == null ? void 0 : _a[index]) ?? null;
}
...
function isDisconnectedNode$1(hydrationInfo, index) {
  ...
  return !!((_a = initDisconnectedNodes(hydrationInfo)) == null ? void 0 : _a.has(index));
}
function processTextNodeBeforeSerialization(context, node) {
  ...
  } else if (((_a = el.nextSibling) == null ? void 0 : _a.nodeType) === Node.TEXT_NODE) {
    corruptedTextNodes.set(
      el,
      "ngtns"
...
function detachViewFromDOM(tView, lView) {
  var _a;
  (_a = lView[ENVIRONMENT].changeDetectionScheduler) == null ? void 0 : _a.notify(8);
...
function renderView(tView, lView, context) {
  ...
  try {
    ...
    (_a = lView[QUERIES]) == null ? void 0 : _a.finishViewCreation(tView);
...
function createAndRenderEmbeddedLView(declarationLView, templateTNode, context, options) {
  ...
  try {
    ...
    const embeddedLView = createLView(declarationLView, embeddedTView, context, viewFlags, null, templateTNode, null, null, (options == null ? void 0 : options.injector) ?? null, (options == null ? void 0 : options.embeddedViewInjector) ?? null, (options == null ? void 0 : options.dehydratedView) ?? null);
...
function detectChangesInternal(lView, notifyErrorHandler = true, mode = 0) {
  ...
  if (!checkNoChangesMode) {
    (_a = rendererFactory.begin) == null ? void 0 : _a.call(rendererFactory);
  }
  try {
...
function refreshView(tView, lView, templateFn, context) {
  ...
  !isInCheckNoChangesPass && ((_a = lView[ENVIRONMENT].inlineEffectRunner) == null ? void 0 : _a.flush());
  enterView(lView);
...
function markViewDirty(lView, source) {
  ...
  (_a = lView[ENVIRONMENT].changeDetectionScheduler) == null ? void 0 : _a.notify(source);
  while (lView) {
...
var R3TemplateRef = class TemplateRef2 extends ViewEngineTemplateRef {
  ...
  get ssrId() {
    var _a;
    return ((_a = this._declarationTContainer.tView) == null ? void 0 : _a.ssrId) || null;
  }
...
function isFirstElementInNgContainer(tNode) {
  var _a;
  return !tNode.prev && ((_a = tNode.parent) == null ? void 0 : _a.type) === 8;
}
...
function isDisconnectedNode(tNode, lView) {
  var _a;
  return !(tNode.type & 16) && !!lView[tNode.index] && !((_a = unwrapRNode(lView[tNode.index])) == null ? void 0 : _a.isConnected);
}
...
function prepareI18nBlockForHydrationImpl(lView, index, parentTNode, subTemplateIndex) {
  ...
  const i18nNodes = hydrationInfo.i18nNodes ?? (hydrationInfo.i18nNodes = /* @__PURE__ */ new Map());
  const caseQueue = ((_a = hydrationInfo.data[I18N_DATA]) == null ? void 0 : _a[index - HEADER_OFFSET]) ?? [];
  const dehydratedIcuData = hydrationInfo.dehydratedIcuData ?? (hydrationInfo.dehydratedIcuData = /* @__PURE__ */ new Map());
  ...
  if (Array.isArray(nodeOrNodes)) {
    ...
    switch (nodeOrNodes.kind) {
      case 0: {
        ...
        setCurrentNode(state, (currentNode == null ? void 0 : currentNode.nextSibling) ?? null);
        break;
      }
      case 1: {
        collectI18nNodesFromDom(context, forkHydrationState(state, ((_a = state.currentNode) == null ? void 0 : _a.firstChild) ?? null), nodeOrNodes.children);
        const currentNode = appendI18nNodeToCollection(context, state, nodeOrNodes);
        setCurrentNode(state, (currentNode == null ? void 0 : currentNode.nextSibling) ?? null);
        break;
      }
        ...
        switch (nodeOrNodes.type) {
          case 0: {
            ...
            if (isSerializedElementContainer(hydrationInfo, noOffsetIndex)) {
              ...
              collectI18nNodesFromDom(context, forkHydrationState(state, ((_b = state.currentNode) == null ? void 0 : _b.firstChild) ?? null), nodeOrNodes.children);
              setCurrentNode(state, (currentNode == null ? void 0 : currentNode.nextSibling) ?? null);
...
function claimDehydratedIcuCaseImpl(lView, icuIndex, caseIndex) {
  var _a;
  const dehydratedIcuDataMap = (_a = lView[HYDRATION]) == null ? void 0 : _a.dehydratedIcuData;
...
function performanceMarkFeature(feature) {
  ...
  (_a = performance == null ? void 0 : performance.mark) == null ? void 0 : _a.call(performance, "mark_feature_usage", { detail: { feature } });
}
...
function hasApplyArgsData(applyArgs, key) {
  ...
  return ((_b = (_a = applyArgs[0]) == null ? void 0 : _a.data) == null ? void 0 : _b[key]) === true;
}
...
function internalAfterNextRender(callback, options) {
  ...
  if (!(options == null ? void 0 : options.runOnServer) && !isPlatformBrowser(injector))
    return;
...
function afterRender(callback, options) {
  ...
  const afterRenderEventManager = injector.get(AfterRenderEventManager);
  const callbackHandler = afterRenderEventManager.handler ?? (afterRenderEventManager.handler = new AfterRenderCallbackHandlerImpl());
  const phase = (options == null ? void 0 : options.phase) ?? AfterRenderPhase.MixedReadWrite;
  const destroy = () => {
...
var AfterRenderCallback = class {
  constructor(phase, callbackFn) {
    ...
    this.errorHandler = inject(ErrorHandler, { optional: true });
    (_a = inject(ChangeDetectionScheduler, { optional: true })) == null ? void 0 : _a.notify(6);
  }
  invoke() {
    var _a;
    try {
...
var _AfterRenderEventManager = class _AfterRenderEventManager {
  ...
  execute() {
    ...
    (_a = this.handler) == null ? void 0 : _a.execute();
  }
  ...
  ngOnDestroy() {
    var _a;
    (_a = this.handler) == null ? void 0 : _a.destroy();
    this.handler = null;
    this.internalCallbacks.length = 0;
  }
};
...
var R3ViewContainerRef = class ViewContainerRef2 extends VE_ViewContainerRef {
  ...
  createComponent(componentFactoryOrType, indexOrOptions, injector, projectableNodes, environmentInjector) {
    ...
    const dehydratedView = findMatchingDehydratedView(this._lContainer, (componentDef == null ? void 0 : componentDef.id) ?? null);
    const rNode = (dehydratedView == null ? void 0 : dehydratedView.firstChild) ?? null;
...
function populateDehydratedViewsInLContainerImpl(lContainer, tNode, hostLView) {
  ...
  const serializedViews = (_a = hydrationInfo.data[CONTAINERS]) == null ? void 0 : _a[noOffsetIndex];
...
function resolveComponentResources(resourceResolver) {
  ...
  componentResourceResolutionQueue.forEach((component, type) => {
    ...
    if (component.styleUrl && ((_a = component.styleUrls) == null ? void 0 : _a.length)) {
...
function mergeInputsWithTransforms(target, source) {
  for (const key in source.inputs) {
    ...
    if (source.inputTransforms !== null) {
      ...
      target.inputTransforms ?? (target.inputTransforms = {});
...
function locateOrCreateContainerAnchorImpl(tView, lView, tNode, index) {
  ...
  const ssrId = ((_a = hydrationInfo.data[TEMPLATES]) == null ? void 0 : _a[index]) ?? null;
...
function getMinimumDurationForState(tDetails, currentState) {
  ...
  if (currentState === DeferBlockState.Placeholder) {
    return ((_a = tDetails.placeholderBlockConfig) == null ? void 0 : _a[MINIMUM_SLOT]) ?? null;
  } else if (currentState === DeferBlockState.Loading) {
    return ((_b = tDetails.loadingBlockConfig) == null ? void 0 : _b[MINIMUM_SLOT]) ?? null;
  }
  return null;
}
function getLoadingBlockAfter(tDetails) {
  var _a;
  return ((_a = tDetails.loadingBlockConfig) == null ? void 0 : _a[LOADING_AFTER_SLOT]) ?? null;
}
...
var LiveCollectionLContainerImpl = class extends LiveCollection {
  ...
  create(index, value) {
    ...
    (_a = this.operationsCounter) == null ? void 0 : _a.recordCreate();
    return embeddedLView;
  }
  destroy(lView) {
    var _a;
    destroyLView(lView[TVIEW], lView);
    (_a = this.operationsCounter) == null ? void 0 : _a.recordDestroy();
  }
  updateValue(index, value) {
  ...
  reset() {
    var _a;
    this.needsIndexUpdate = false;
    (_a = this.operationsCounter) == null ? void 0 : _a.reset();
  }
  updateIndexes() {
...
function ɵɵrepeater(collection) {
  ...
  try {
    ...
    if (ngDevMode && metadata.trackByFn === ɵɵrepeaterTrackByIdentity && ((_a = liveCollection.operationsCounter) == null ? void 0 : _a.wasReCreated(liveCollection.length)) && isViewExpensiveToRecreate(getExistingLViewFromLContainer(lContainer, 0))) {
...
function getDependenciesForTokenInInjector(token, injector) {
  ...
  if (!(injector instanceof NodeInjector)) {
    return ((_b = (_a = resolverToTokenToDependencies.get(injector)) == null ? void 0 : _a.get) == null ? void 0 : _b.call(_a, token)) ?? [];
  }
  const lView = getNodeInjectorLView(injector);
  ...
  return dependencies.filter((dependency) => {
    var _a2;
    const dependencyNode = (_a2 = dependency.injectedIn) == null ? void 0 : _a2.tNode;
    ...
    if (!visitedContainers.has(container)) {
      for (const prov of providerToPath.keys()) {
        ...
        deepForEach(containerDef.imports, (moduleImport) => {
          ...
          if (isNextStepInPath) {
            (_a = providerToPath.get(prov)) == null ? void 0 : _a.unshift(container);
          }
        });
      }
    }
...
function getInjectorParent(injector) {
  ...
  if (hasParentInjector(parentLocation)) {
    ...
    const injectorParent = (_a = chainedInjector.injector) == null ? void 0 : _a.parent;
  ...
  detectChangesInAttachedViews(refreshViews) {
    ...
    while (runs < MAXIMUM_REFRESH_RERUNS) {
      ...
      if (refreshViews || !isFirstPass) {
        ...
        (_a = rendererFactory == null ? void 0 : rendererFactory.begin) == null ? void 0 : _a.call(rendererFactory);
...
var _NgZoneChangeDetectionScheduler = class _NgZoneChangeDetectionScheduler {
  ...
  ngOnDestroy() {
    var _a;
    (_a = this._onMicrotaskEmptySubscription) == null ? void 0 : _a.unsubscribe();
  }
};
...
function internalProvideZoneChangeDetection({ ngZoneFactory, ignoreChangesOutsideZone }) {
  ngZoneFactory ?? (ngZoneFactory = () => new NgZone(getNgZoneOptions()));
  return [
...
function getNgZoneOptions(options) {
  return {
    ...
    shouldCoalesceEventChangeDetection: (options == null ? void 0 : options.eventCoalescing) ?? false,
    shouldCoalesceRunChangeDetection: (options == null ? void 0 : options.runCoalescing) ?? false
  };
}
...
var _ChangeDetectionSchedulerImpl = class _ChangeDetectionSchedulerImpl {
  ...
  cleanup() {
    ...
    this.shouldRefreshViews = false;
    this.runningTick = false;
    (_a = this.cancelScheduledCallback) == null ? void 0 : _a.call(this);
    this.cancelScheduledCallback = null;
  ...
  bootstrapModuleFactory(moduleFactory, options) {
    ...
    return ngZone.run(() => {
      ...
      if (typeof ngDevMode === "undefined" || ngDevMode) {
        ...
        if (moduleRef.injector.get(ZONELESS_ENABLED) && (options == null ? void 0 : options.ngZone) !== "noop") {
...
function provideExperimentalCheckNoChangesForDebug(options) {
  if (typeof ngDevMode === "undefined" || ngDevMode) {
    ...
    const checkNoChangesMode = (options == null ? void 0 : options.exhaustive) === false ? CheckNoChangesMode.OnlyDirtyViews : CheckNoChangesMode.Exhaustive;
    return makeEnvironmentProviders([
      (options == null ? void 0 : options.useNgZoneOnStable) ? { provide: NgZone, useFactory: () => new DebugNgZoneForCheckNoChanges(checkNoChangesMode) } : [],
      (options == null ? void 0 : options.interval) !== void 0 ? exhaustiveCheckNoChangesInterval(options.interval, checkNoChangesMode) : [],
      {
        provide: ENVIRONMENT_INITIALIZER,
        multi: true,
        useValue: () => {
          if ((options == null ? void 0 : options.useNgZoneOnStable) && !(inject(NgZone) instanceof DebugNgZoneForCheckNoChanges)) {
...
var DebugNgZoneForCheckNoChanges = class extends NgZone {
  constructor(checkNoChangesMode) {
    ...
    if (zonelessEnabled) {
      ...
      this.onStable.emit = () => {
        this.scheduler || (this.scheduler = this.injector.get(ChangeDetectionSchedulerImpl));
  ...
  checkApplicationViews() {
    ...
    for (const view of this.applicationRef.allViews) {
      try {
        ...
        this.errorHandler || (this.errorHandler = this.injector.get(ErrorHandler));
...
var DebugElement = class extends DebugNode {
  ...
  get styles() {
    const element = this.nativeElement;
    return (element == null ? void 0 : element.style) ?? {};
  }
  /**
...
var _ImagePerformanceWarning = class _ImagePerformanceWarning {
  ...
  start() {
    var _a, _b;
    if (typeof PerformanceObserver === "undefined" || ((_a = this.options) == null ? void 0 : _a.disableImageSizeWarning) && ((_b = this.options) == null ? void 0 : _b.disableImageLazyLoadWarning)) {
      return;
    }
  ...
  scanImages() {
    ...
    images.forEach((image) => {
      var _a2, _b;
      if (!((_a2 = this.options) == null ? void 0 : _a2.disableImageSizeWarning)) {
    ...
    if (lcpElementFound && !lcpElementLoadedCorrectly && this.lcpImageUrl && !((_a = this.options) == null ? void 0 : _a.disableImageLazyLoadWarning)) {
        ...
        if (isPlatformBrowser()) {
          ...
          return () => {
            whenStable(appRef).then(() => {
              ...
              const container = (_a = globalThis[CONTRACT_PROPERTY]) == null ? void 0 : _a[appId];
...
function handleEvent(event) {
  var _a, _b;
  const handlerFns = (_b = (_a = event.currentTarget) == null ? void 0 : _a.__jsaction_fns) == null ? void 0 : _b.get(event.type);
  if (!handlerFns) {
    return;
  }
...
function componentUsesShadowDomEncapsulation(lView) {
  ...
  return (instance == null ? void 0 : instance.constructor) ? ((_a = getComponentDef(instance.constructor)) == null ? void 0 : _a.encapsulation) === ViewEncapsulation$1.ShadowDom : false;
}
...
function verifySsrContentsIntegrity() {
  ...
  for (const node of doc.body.childNodes) {
    if (node.nodeType === Node.COMMENT_NODE && ((_a = node.textContent) == null ? void 0 : _a.trim()) === SSR_CONTENT_INTEGRITY_MARKER) {
...
var EffectHandle = class {
  ...
  destroy() {
    ...
    (_a = this.unregisterOnDestroy) == null ? void 0 : _a.call(this);
  }
};
function effect(effectFn, options) {
  ...
  const handle = new EffectHandle(injector.get(APP_EFFECT_SCHEDULER), effectFn, typeof Zone === "undefined" ? null : Zone.current, destroyRef, injector, (options == null ? void 0 : options.allowSignalWrites) ?? false);
  const cdr = injector.get(ChangeDetectorRef, null, { optional: true });
  if (!cdr || !(cdr._lView[FLAGS] & 8)) {
    handle.watcher.notify();
  } else {
    ((_a = cdr._lView)[EFFECTS_TO_SCHEDULE] ?? (_a[EFFECTS_TO_SCHEDULE] = [])).push(handle.watcher.notify);
  }
  return handle;
}
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-F5W7JMMH.js.map
