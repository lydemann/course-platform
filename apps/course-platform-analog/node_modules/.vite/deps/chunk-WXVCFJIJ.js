...
// node_modules/.pnpm/@angular+material@18.0.1_@angular+animations@18.0.1_@angular+core@18.0.1_rxjs@7.8.1_zone.js@0_uua6ktl5ocburfvrx6mhehqyf4/node_modules/@angular/material/fesm2022/form-field.mjs
var _c0 = ["notch"];
...
var _MatFormField = class _MatFormField {
  ...
  get floatLabel() {
    var _a;
    return this._floatLabel || ((_a = this._defaults) == null ? void 0 : _a.floatLabel) || DEFAULT_FLOAT_LABEL;
  }
  ...
  set appearance(value) {
    ...
    const newAppearance = value || ((_a = this._defaults) == null ? void 0 : _a.appearance) || DEFAULT_APPEARANCE;
  ...
  get subscriptSizing() {
    var _a;
    return this._subscriptSizing || ((_a = this._defaults) == null ? void 0 : _a.subscriptSizing) || DEFAULT_SUBSCRIPT_SIZING;
  }
  set subscriptSizing(value) {
    var _a;
    this._subscriptSizing = value || ((_a = this._defaults) == null ? void 0 : _a.subscriptSizing) || DEFAULT_SUBSCRIPT_SIZING;
  }
  ...
  constructor(_elementRef, _changeDetectorRef, _unusedNgZone, _dir, _platform, _defaults, _animationMode, _unusedDocument) {
    ...
    if (_defaults) {
      ...
      this._hideRequiredMarker = Boolean(_defaults == null ? void 0 : _defaults.hideRequiredMarker);
      if (_defaults.color) {
  ...
  _updateFocusState() {
    ...
    if (this._control.focused && !this._isFocused) {
      ...
      (_a = this._lineRipple) == null ? void 0 : _a.activate();
  ...
  _refreshOutlineNotchWidth() {
    ...
    if (!this._hasOutline() || !this._floatingLabel || !this._shouldLabelFloat()) {
      (_a = this._notchedOutline) == null ? void 0 : _a._setNotchWidth(0);
    } else {
  ...
  _updateOutlineLabelOffset() {
    ...
    const iconPrefixContainer = (_a = this._iconPrefixContainer) == null ? void 0 : _a.nativeElement;
...
//# sourceMappingURL=chunk-WXVCFJIJ.js.map
