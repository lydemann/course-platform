...
// node_modules/.pnpm/@angular+cdk@18.0.1_@angular+common@18.0.1_@angular+core@18.0.1_rxjs@7.8.1_zone.js@0.14.3__rx_rk6fatukoi4qp5fzalhod5vxee/node_modules/@angular/cdk/fesm2022/drag-drop.mjs
...
function extendStyles(dest, source, importantProperties2) {
  for (let key in source) {
    if (source.hasOwnProperty(key)) {
      ...
      if (value) {
        dest.setProperty(key, value, (importantProperties2 == null ? void 0 : importantProperties2.has(key)) ? "important" : "");
      } else {
...
var PreviewRef = class {
  ...
  destroy() {
    ...
    (_a = this._previewEmbeddedView) == null ? void 0 : _a.destroy();
...
var DragRef = class {
  ...
  _removeListeners() {
    ...
    (_a = this._getShadowRoot()) == null ? void 0 : _a.removeEventListener("selectstart", shadowDomSelectStart, activeCapturingEventOptions$1);
  }
  /** Destroys the preview element and its ViewRef. */
  _destroyPreview() {
    var _a;
    (_a = this._preview) == null ? void 0 : _a.destroy();
    this._preview = null;
  }
  ...
  _getViewportScrollPosition() {
    var _a;
    return ((_a = this._parentPositions.positions.get(this._document)) == null ? void 0 : _a.scrollPosition) || this._parentPositions.getViewportScrollPosition();
  }
  /**
...
var SingleAxisSortStrategy = class {
  ...
  reset() {
    this._activeDraggables.forEach((item) => {
      ...
      if (rootElement) {
        const initialTransform = (_a = this._itemPositions.find((p) => p.drag === item)) == null ? void 0 : _a.initialTransform;
...
var _CdkDragHandle = class _CdkDragHandle {
  ...
  constructor(element, _parentDrag) {
    ...
    _parentDrag == null ? void 0 : _parentDrag._addHandle(this);
  }
  ngOnDestroy() {
    var _a;
    (_a = this._parentDrag) == null ? void 0 : _a._removeHandle(this);
...
var _CdkDrag = class _CdkDrag {
  ...
  constructor(element, dropContainer, _document, _ngZone, _viewContainerRef, config, _dir, dragDrop, _changeDetectorRef, _selfHandle, _parentDrag) {
    ...
    this._dragRef = dragDrop.createDrag(element, {
      ...
      zIndex: config == null ? void 0 : config.zIndex
    });
  ...
  _updateRootElement() {
    ...
    if (this.rootElementSelector) {
      rootElement = element.closest !== void 0 ? element.closest(this.rootElementSelector) : (
        ...
        (_a = element.parentElement) == null ? void 0 : _a.closest(this.rootElementSelector)
      );
    }
    ...
    ref.beforeStarted.pipe(take(1)).subscribe(() => {
      ...
      while (parent) {
        if (parent.classList.contains(DRAG_HOST_CLASS)) {
          ref.withParent(((_a = _CdkDrag._dragInstances.find((drag) => {
...
var _CdkDragPreview = class _CdkDragPreview {
  constructor(templateRef) {
    ...
    (_a = this._drag) == null ? void 0 : _a._setPreviewTemplate(this);
  }
  ngOnDestroy() {
    var _a;
    (_a = this._drag) == null ? void 0 : _a._resetPreviewTemplate(this);
  }
};
...
var _CdkDragPlaceholder = class _CdkDragPlaceholder {
  constructor(templateRef) {
    ...
    (_a = this._drag) == null ? void 0 : _a._setPlaceholderTemplate(this);
  }
  ngOnDestroy() {
    var _a;
    (_a = this._drag) == null ? void 0 : _a._resetPlaceholderTemplate(this);
  }
};
