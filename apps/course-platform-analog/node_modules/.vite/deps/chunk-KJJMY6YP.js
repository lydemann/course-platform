...
// node_modules/.pnpm/@angular+router@18.0.1_@angular+common@18.0.1_@angular+core@18.0.1_rxjs@7.8.1_zone.js@0.14.3__arlg4wqmve3ehhtjv4farp7yyy/node_modules/@angular/router/fesm2022/router.mjs
...
var ActivatedRoute = class {
  ...
  constructor(urlSubject, paramsSubject, queryParamsSubject, fragmentSubject, dataSubject, outlet, component, futureSnapshot) {
    ...
    this.title = ((_a = this.dataSubject) == null ? void 0 : _a.pipe(map((d) => d[RouteTitleKey]))) ?? of(void 0);
    this.url = urlSubject;
  ...
  !parent.component && !((_a = parent.routeConfig) == null ? void 0 : _a.loadComponent))) {
    inherited = {
      ...
      resolve: {
        ...
        ...routeConfig == null ? void 0 : routeConfig.data,
...
var _NavigationTransitions = class _NavigationTransitions {
  ...
  handleNavigationRequest(request) {
    ...
    (_a = this.transitions) == null ? void 0 : _a.next({
          ...
          switchMap((t) => {
            ...
            if (this.urlHandlingStrategy.shouldProcessUrl(t.rawUrl)) {
              return of(t).pipe(
                ...
                switchMap((t2) => {
                  var _a, _b;
                  const transition = (_a = this.transitions) == null ? void 0 : _a.getValue();
            ...
            if (isNavigationCancelingError(e)) {
              ...
              try {
                const navigationErrorHandlerResult = runInInjectionContext(this.environmentInjector, () => {
                  var _a;
                  return (_a = this.navigationErrorHandler) == null ? void 0 : _a.call(this, navigationError);
                });
...
var _HistoryStateManager = class _HistoryStateManager extends StateManager {
  ...
  get browserPageId() {
    ...
    return ((_a = this.restoredState()) == null ? void 0 : _a.ɵrouterPageId) ?? this.currentPageId;
  }
  getRouterState() {
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-KJJMY6YP.js.map
