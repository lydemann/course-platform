...
// node_modules/.pnpm/@angular+common@18.0.1_@angular+core@18.0.1_rxjs@7.8.1_zone.js@0.14.3__rxjs@7.8.1/node_modules/@angular/common/fesm2022/common.mjs
var _DOM = null;
function getDOM() {
  return _DOM;
}
...
var _PathLocationStrategy = class _PathLocationStrategy extends LocationStrategy {
  constructor(_platformLocation, href) {
    ...
    this._baseHref = href ?? this._platformLocation.getBaseHrefFromDOM() ?? ((_a = inject(DOCUMENT).location) == null ? void 0 : _a.origin) ?? "";
  }
  /** @nodoc */
  ngOnDestroy() {
...
var _DatePipe = class _DatePipe {
  ...
  transform(value, format, timezone, locale) {
    ...
    if (value == null || value === "" || value !== value)
      return null;
    try {
      const _format = format ?? ((_a = this.defaultOptions) == null ? void 0 : _a.dateFormat) ?? DEFAULT_DATE_FORMAT;
...
function createNetlifyUrl(config, path) {
  ...
  const configQuality = ((_a = config.loaderParams) == null ? void 0 : _a["quality"]) ?? ((_b = config.loaderParams) == null ? void 0 : _b["q"]);
...
var _PreconnectLinkChecker = class _PreconnectLinkChecker {
  ...
  assertPreconnect(rewrittenSrc, originalNgSrc) {
    ...
    this.preconnectLinks ?? (this.preconnectLinks = this.queryPreconnectLinks());
...
@angular/common/fesm2022/common.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-GAVWN3A4.js.map
