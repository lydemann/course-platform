...
// node_modules/.pnpm/@angular+animations@18.0.1_@angular+core@18.0.1_rxjs@7.8.1_zone.js@0.14.3_/node_modules/@angular/animations/fesm2022/browser.mjs
var LINE_START = "\n - ";
...
var AnimationTimelineBuilderVisitor = class {
  ...
  _applyAnimationRefDelays(animationsRefsOptions, context, innerContext) {
    for (const animationRefOptions of animationsRefsOptions) {
      ...
      if (animationDelay) {
        const animationDelayValue = typeof animationDelay === "number" ? animationDelay : resolveTimingValue(interpolateParams(animationDelay, (animationRefOptions == null ? void 0 : animationRefOptions.params) ?? {}, context.errors));
...
var TransitionAnimationEngine = class {
  ...
  _flushAnimations(cleanupFns, microtaskId) {
    ...
    replaceNodes.forEach((node) => {
      ...
      postStylesMap.set(node, new Map([...(post == null ? void 0 : post.entries()) ?? [], ...(pre == null ? void 0 : pre.entries()) ?? []]));
    });
    const rootPlayers = [];
    const subPlayers = [];
...
// node_modules/.pnpm/@angular+platform-browser@18.0.1_@angular+animations@18.0.1_@angular+core@18.0.1_rxjs@7.8.1_z_nhlre5bnchtmrzglwmzd54hxve/node_modules/@angular/platform-browser/fesm2022/animations.mjs
